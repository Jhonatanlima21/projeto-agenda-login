...
mongoose.connect('mongodb+srv://jhonatanlima:Jhonatan21@cluster0.tjwzo.mongodb.net/app-mean?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true})
.then(() => {
